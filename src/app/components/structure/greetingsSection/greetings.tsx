...
export default function GreetingsSection() {
  const phrases = [
    ...
    "Or just curious",
    "You know what?",
    "Press the light button 10 times real fast",
    "I'll be waiting",
    "...",
    "...",
    "...",
    "I hope you didn't waste your time doing that",
    "Nobody usually reaches this far",
    "Anyway, I hope you had fun!",
    "Now this array will reset to it's boring, regular state"
  ];
